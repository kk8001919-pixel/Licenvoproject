  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h1 className="font-display text-3xl font-bold text-foreground">Chiavi</h1>
        <p className="text-muted-foreground">
          La gestione delle chiavi di attivazione avviene tramite i metafields dei prodotti Shopify.
        </p>
      </div>
      ...
      >
        <div className="w-12 h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center flex-shrink-0">
          <Icon name="KeyRound" size={22} className="text-emerald-400" />
        </div>
        <div className="flex-1">
          <h3 className="font-display text-lg font-bold text-foreground mb-0.5">
            Gestisci chiavi su Shopify
          </h3>
          <p className="text-sm text-muted-foreground">
            Le chiavi di attivazione sono gestite tramite i metafields dei prodotti. Accedi al pannello Shopify per aggiungere, modificare o rimuovere chiavi.
          </p>
        </div>
      ...
      <div className="flex items-start gap-3 p-4 rounded-2xl bg-blue-500/5 border border-blue-500/20">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          Puoi configurare la consegna automatica delle chiavi tramite le app Shopify dedicate alla gestione delle digital keys, oppure gestire le chiavi manualmente tramite i metafields dei prodotti.
        </p>
      </div>
    </div>
  );
